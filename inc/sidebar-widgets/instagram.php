...
----------------------------------------*/
class busicol_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('busicol_instagram_photo',esc_html__('[ Busicol ] Intagram Photo','busicol-companion'),array(
			'description' => esc_html__('Busicol Instagram Photo Widget','busicol-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'busicol-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'busicol-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'busicol-companion'); ?></label>
...
if(!function_exists('busicol_instagram_widgets')):
	function busicol_instagram_widgets(){
		register_widget('busicol_instagram_photo');
	}
	add_action('widgets_init','busicol_instagram_widgets');
endif;
