...
class Busicol_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'busicol_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Busicol ] Social Links', 'busicol-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'busicol-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'busicol-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'busicol-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'busicol-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'busicol-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'busicol-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'busicol-companion'); ?></label>
...
} // Class busicol_social_links ends here


// Register and load the widget
function busicol_social_links_widget_load() {
	register_widget( 'Busicol_social_links' );
}
add_action( 'widgets_init', 'busicol_social_links_widget_load' );